    ...
    if (navigator.share) {
      try {
        await navigator.share({
          title: 'Claim Your Volunteer Profile',
          text: 'A volunteer profile was created for you. Click the link to claim it!',
          url: claimUrl,
        })
      } catch {
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          onClick={handleCopy}
          className="flex items-center gap-1 px-3 py-2 rounded-lg border border-gray-300 hover:bg-gray-50 transition-colors text-sm font-medium text-gray-700 whitespace-nowrap"
        >
          {copied ? (
            <>
