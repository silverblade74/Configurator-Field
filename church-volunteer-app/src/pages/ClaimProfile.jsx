      ...
      <div className="max-w-md w-full">
        ...
        <div className="card text-center">
          ...
          <h2 className="text-lg font-semibold text-gray-800 mb-2">
            Hi, {volunteer.displayName || 'Volunteer'}!
          </h2>
          <p className="text-gray-500 mb-6">
            A volunteer profile was created for you at VolunteerHub.
            Claim it to track your hours, earn badges, and stay connected.
          </p>
          ...
          {currentUser ? (
            ...
            <div className="space-y-3">
              <p className="text-sm text-gray-500 mb-4">
                Sign up or log in to claim this profile.
              </p>
              <button
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 border border-gray-300 rounded-lg px-4 py-2 hover:bg-gray-50 transition-colors text-sm font-medium text-gray-700"
              >
