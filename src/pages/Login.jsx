...
export default function Login() {
  ...
  async function handleSubmit(e) {
    ...
    catch (err) { setError(err.code === 'auth/invalid-credential' ? 'Invalid email or password' : 'Failed to log in. Please try again.') }
    setLoading(false)
  }
  ...
  async function handleGoogle() {
    ...
    catch (err) { setError('Failed to log in with Google.') }
  }
      ...
      <div className="max-w-md w-full">
        ...
        <div className="card">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div><label className="label">Password</label><input type="password" className="input" value={password} onChange={(e) => setPassword(e.target.value)} required placeholder="Enter your password" /></div>
